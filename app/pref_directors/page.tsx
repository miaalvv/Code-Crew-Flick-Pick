...
export default function DirectorPreferencePage () {
    ...
    const sortedDirectors = sortMethod === 'popularity'
        ? [...filteredDirectors].sort ((a, b) => b.popularity - a.popularity)
        : filteredDirectors.sort ((a, b) => a.name.localeCompare (b.name));
            ...
            <section className="rounded-3xl border border-slate-700/70 bg-slate-900/80 p-6 shadow-xl shadow-black/40 space-y-5">
                ...
                <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            type="button"
                            onClick={() => document.getElementById('save-directors')?.scrollIntoView({ behavior: 'smooth', block: 'center' })}
                ...
                <div id="save-directors" className="flex items-center justify-between gap-3 pt-2 text-xs text-slate-400">
